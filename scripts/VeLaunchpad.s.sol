...
import "../src/test/helpers/MyToken.sol";

import {IRewardDistributor} from "../src/IRewardDistributor.sol";
// import {RewardDistributor} from "../src/RewardDistributor.sol";
import {IBleuVotingEscrow} from "../src/IBleuVotingEscrow.sol";
import {IVeLaunchpad} from "../src/IVeLaunchpad.sol";
...
contract VeLaunchpad is Script {
    address private _veLaunchpadAddress;
    address private _votingEscrowBlueprint;
    address private _rewardDistributorBlueprint;
    ...
    function run() external {
        ...
        _votingEscrowBlueprint = deployVyperBlueprint("VotingEscrowBlueprint");
        _rewardDistributorBlueprint = deploySolidityBlueprint(
